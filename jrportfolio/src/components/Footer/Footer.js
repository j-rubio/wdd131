export const Footer = () => {
  return `
      <address style="display: flex; flex-direction: column;  align-items: center;">
        <p><a href="tel:+19453011095" style="padding: 3px 16px; display: inline-block;">+1 (945) 301-1095</a></p>
